        ...
        <ul class="nav navbar-nav">
          ...
          <div class="collapse navbar-collapse nav-wil" >
            <ul class="nav navbar-nav " style="color: black;">
              <li class="act"><a href="coordinator.php" >Home</a></li>
              <?php
                if(isset($_SESSION['manage_name']))
                { 
                 ?>
                <li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?=$_SESSION['manage_name']?><span class="caret"></span></a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <?php 
          if(isset($_SESSION['manage_image']))
          {
         ?>
        <div class="pull-left image">
          <?php echo '<img src="images/'.$_SESSION["manage_image"].'" class="img-circle" alt="User Image"/>';?>
        </div>
        <?php } ?>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="coordinator.php"><i class="fa fa-circle-o"></i>Co-ordinator Management</a></li>
