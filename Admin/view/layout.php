                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <div class="collapse navbar-collapse nav-wil">
                                <ul class="nav navbar-nav " style="color: black;">
                                    <li class="act"><a href="student.php">Home</a></li>
                                    <?php
                 ...
                 ?>
                                        <li>
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                                <?=$_SESSION['admin_name']?><span class="caret"></span></a>
            ...
            <aside class="main-sidebar">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                            ...
                            <ul class="treeview-menu">
                                <li><a href="faculty.php"><i class="fa fa-circle-o"></i>Faculty Management</a></li>
                                <li><a href="student.php"><i class="fa fa-circle-o"></i>Student Management</a></li>
                                <li><a href="manager.php"><i class="fa fa-circle-o"></i>Manager Management</a></li>
                                <li><a href="countwritten.php"><i class="fa fa-circle-o"></i>View written</a></li>
                            </ul>
                        </li>
