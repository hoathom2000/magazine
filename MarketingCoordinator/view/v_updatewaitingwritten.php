...
if(isset($_POST['updatePosting'])){
  if(isset($_POST['id']))
    {

          $id = $_POST['id'];
        $cwritten = new c_PostingWritten();
        $cwritten->postUpdateWritten($id);
              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="post">
                  ...
                  <!-- /.row -->
                        ...
                        <button name="updatePosting" type="submit" class="btn btn-info btn-block btn-sm">Accept Posting</button>
